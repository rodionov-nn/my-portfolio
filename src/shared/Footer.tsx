...
export default function Footer() {
  return (
    <footer className="mt-8 px-2 sm:px-4 md:px-8 2xl:px-50 w-full h-fit font-mono rounded-t-xl border border-neutral-400 dark:border-neutral-700 bg-neutral-100/30 dark:bg-neutral-900/30 backdrop-blur-sm select-none">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 w-full sm:w-auto items-center sm:items-start justify-center sm:justify-end text-base xl:text-2xl">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4 items-center mt-2 sm:mt-0">
            <ExternalLinkButton
              ...
              iconLeft={<FaGithub className="sm:h-5 sm:w-5" />}
            ...
            <ExternalLinkButton
              ...
              iconLeft={<FaInstagram className="sm:h-5 sm:w-5" />}
              className="p-2 text-xs sm:text-base rounded-full"
            >
              Instagram
            </ExternalLinkButton>
            <ExternalLinkButton
              ...
              iconLeft={<FaLinkedin className="sm:h-5 sm:w-5" />}
              className="col-span-full p-2 text-xs sm:text-base rounded-full"
            >
              Linkedin
            </ExternalLinkButton>
          </div>
