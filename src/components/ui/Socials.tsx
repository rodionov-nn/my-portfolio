...
export default function Socials() {
  return (
    <div className="hidden md:flex fixed right-0 bottom-0 z-10 text-2xl p-1.5 m-1.5 items-center justify-center rounded-full bg-neutral-300/20 dark:bg-neutral-700/20 border border-neutral-400 dark:border-neutral-700 backdrop-blur-md shadow-neutral-900/50 dark:shadow-neutral-600/50 shadow-md">
