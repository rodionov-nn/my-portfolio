  ...
  return (
    ...
    >
      <Container className="flex flex-col min-h-screen items-center justify-center gap-8 md:gap-16 py-16">
        <h1 className="text-4xl md:text-7xl font-extrabold text-center bg-gradient-to-b from-primary-dark to-primary dark:from-primary dark:to-primary-dark bg-clip-text text-transparent">
          Skills & Stack
        </h1>
