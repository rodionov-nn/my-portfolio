...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-transparent to-neutral-100 dark:to-neutral-900 h-svh">
      <Container className="flex flex-col items-center justify-center h-full text-center gap-4">
        ...
        <Link
          href="#contact"
          className="relative font-mono z-10 hover:translate-y-1"
        >
          <p className="p-2 uppercase font-bold backdrop-blur-xs shadow-xs rounded-full border border-neutral-400 dark:border-neutral-700 bg-neutral-200/30 dark:bg-neutral-900/30 hover:bg-neutral-400/30 dark:hover:bg-neutral-700/30">
